...
export const getQueuedLocalRemoteMappings = async () => offlineError('getQueuedLocalRemoteMappings');
export const removeQueuedLocalRemoteMapping = async () => offlineError('removeQueuedLocalRemoteMapping');
export const flushQueuedLocalRemoteMappings = async () => offlineError('flushQueuedLocalRemoteMappings');
