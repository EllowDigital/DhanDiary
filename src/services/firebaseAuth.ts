// This file previously contained Firebase-based auth logic.
// Project migrated to local auth (`src/services/auth.ts`).
// Re-export everything from the local auth shim to preserve import paths.
